...
class SetCriterion(nn.Module):
    ...
    def loss_labels(self, outputs, targets, indices, num_boxes, log=True):
        ...
        target_classes_o = torch.cat([t["labels"][J.long()] for t, (_, J) in zip(targets, indices)])
    ...
    def loss_boxes(self, outputs, targets, indices, num_boxes):
        ...
        target_boxes = torch.cat([t['boxes'][i.long()] for t, (_, i) in zip(targets, indices)], dim=0)
